...
\title{How to Play: Back Alley Bridge}
\author{Written by Ryan Evaul}
% Last Modified Date
\newcommand{\datechanged}{Last Updated: September 10th, 2018}
\date{\datechanged}
...
\article{Objective}
To have the most point by the end of the game.
...
\article{Determining Dealer}
The first dealer will be chosen using the following process.
\begin{enumerate}
